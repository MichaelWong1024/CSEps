...
void addHex(char* hex1, char* hex2, int totalBits, int mantissaBits) {
    ...
    // Handle special case for the first value
    if (specialCase1) {
        printf("Value 1: Inf\n");
        float1 = INFINITY;
    } else {
    ...
    // Handle special case for the second value
    if (specialCase2) {
        printf("Value 2: Inf\n");
        float2 = INFINITY;
    } else {
    ...
    // Perform addition and handle special case
    double sum;
    if (specialCase1 || specialCase2) {
        sum = INFINITY;
    } else {
    ...
    // Print results
    printf("Sum: %s\n", (specialCase1 || specialCase2) ? "Inf" : "Finite");
    printf("Binary Sum: %s\n", sumBinary);
    printf("Hex Sum: %s\n", sumHex);
